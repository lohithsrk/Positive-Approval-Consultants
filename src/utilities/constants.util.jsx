...
export const services = [
	{
		title: 'Corporation Approvals',
		description: "We facilitate and assisting in getting Corporation Approval, ensuring compliance with regulatory requirements",
		points: [
			"Building Plan Approval",
			"Subdivision approval",
			"Regularisation of Layout"
		]
	},
	{
		title: 'CMDA Approvals',
		description: "We provide comprehensive consultation in Chennai ensuring timely and hassle free CMDA Approvals. Our expertise in CMDA regulations and Procedures enables us to provide efficient and reliable services, saving you time and resources.",
		points: [
			"Land Conversion",
			"Layout",
			"Subdivision",
			"Independent House Approval/ Villa Approval",
			"Non-High-Rise Building Approval",
			"High Rise Building Approval",
			"Group Development",
			"Regularisation of Plot and Buildings",
			"Completion Certificate"
		]
	},
	{
		title: 'DTCP Approvals',
		description: "We Offer end to end solutions for Building Approval. With in-depth knowledge of DTCP regulations and Procedures and our expertise translate into tangible benefits for your Projects. Our Comprehensive consultancy services includes.",
		points: [
			"Wet Land NOC ",
			"Land Conversion ",
			"Layout ",
...
export { ourDNA, benefitOne, benefitTwo };
